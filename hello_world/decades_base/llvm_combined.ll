; ModuleID = 'decades_base/llvm_combined.ll'
...
@1 = private unnamed_addr global %struct.ident_t { i32 0, i32 34, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0) }, align 8
...
entry:
  %0 = tail call i32 @__kmpc_global_thread_num(%struct.ident_t* nonnull @0)
...
define dso_local i32 @DECADES_FETCH_MIN(i32* %addr, i32 %to_min) local_unnamed_addr #2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local float @DECADES_FETCH_ADD_FLOAT(float* %addr, float %to_add) local_unnamed_addr #2 {
entry:
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 1024, i8* nonnull %1) #7
...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @0, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, [256 x float]*, [256 x float]*, [256 x float]*)* @.omp_outlined. to void (i32*, i32*, ...)*), [256 x float]* nonnull %a, [256 x float]* nonnull %b, [256 x float]* nonnull %c)
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %1) #7
  ret i32 0
