...
namespace {
  ...
  int EXCLUSIVE_LOADS = 0;
  int EXCLUSIVE_STORES = 0;
  int EXCLUSIVE_RMWS = 0;

  Function *dec_load32_async;
  Function *dec_load64_async;
  Function *dec_atomic_fetch_add_async;
  Function *dec_atomic_fetch_add_float_async;
  Function *dec_atomic_fetch_and_async;
  Function *dec_atomic_fetch_or_async;
  Function *dec_atomic_fetch_xor_async;
  Function *dec_atomic_fetch_max_async;
  Function *dec_atomic_fetch_min_async;
  Function *dec_atomic_exchange_async;
  Function *dec_atomic_compare_exchange_async;
  Function *dec_atomic_fetch_add;
  Function *dec_atomic_fetch_add_float;
  Function *dec_atomic_fetch_min;
  Function *dec_atomic_compare_exchange;
  ...
  void populate_functions(Module &M) {
    ...
    dec_load32_async = (Function *) M.getOrInsertFunction("dec_load32_async",
							  FunctionType::get(Type::getVoidTy(M.getContext()),
									    Type::getInt64Ty(M.getContext()),
									    Type::getInt32Ty(M.getContext())->getPointerTo())).getCallee();
    
    
    dec_load64_async = (Function *) M.getOrInsertFunction("dec_load64_async",
							  FunctionType::get(Type::getVoidTy(M.getContext()),
									    Type::getInt64Ty(M.getContext()),
									    Type::getInt64Ty(M.getContext())->getPointerTo())).getCallee();
    ...
    dec_atomic_fetch_add_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add_async",
    ...
    */
    ...
    dec_atomic_fetch_add = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add",
    ...
    dec_atomic_fetch_add_float_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add_float_async",
								    FunctionType::get(Type::getFloatTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_fetch_add_float_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_add_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    */
    ...
    dec_atomic_fetch_and_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_and_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_fetch_or_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_or_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_fetch_xor_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_xor_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_fetch_max_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_max_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_fetch_min_async = (Function *) M.getOrInsertFunction("dec_atomic_fetch_min_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    */    
    ...
    types.push_back(Type::getInt64Ty(M.getContext()));
    //types.push_back(Type::getInt32PtrTy(M.getContext())->getPointerTo());
    types.push_back(Type::getInt32PtrTy(M.getContext()));
    types.push_back(Type::getInt32Ty(M.getContext()));    
    
    dec_atomic_exchange_async = (Function *) M.getOrInsertFunction("dec_atomic_exchange_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_compare_exchange_async = (Function *) M.getOrInsertFunction("dec_atomic_compare_exchange_async",
								    FunctionType::get(Type::getVoidTy(M.getContext()), &types[0])).getCallee();
    ...
    dec_atomic_compare_exchange = (Function *)  M.getOrInsertFunction("dec_atomic_compare_exchange",
								      FunctionType::get(Type::getInt32Ty(M.getContext()), &types[0])).getCallee();

    
    // *****************************************
    // What do we do with the functions below?
    // *****************************************
  ...
  bool isa_supply_exclusive(Instruction *I) {
    if (isa<CallInst>(I)) {
      CallInst *CI = dyn_cast<CallInst>(I);
      if (CI->getCalledFunction() == NULL) {
        return false;
      }
      if (CI->getCalledFunction()->getName().str().find("supply_exclusive") != std::string::npos) {
        return true;
      }
    }
    return false;
  ...
  void promoteRMW(Module &M, CallInst *CI) {
    ...
    if (rmw_name.find("dec_atomic_compare_exchange") != std::string::npos) {
      //Builder.CreateCall(dec_atomic_compare_exchange_async, args);
      Builder.CreateCall(supply_alu_rmw_cas, args);
    }
    else if (rmw_name.find("dec_atomic_fetch_add") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_add_async, args);
    } 
    else if (rmw_name.find("dec_atomic_fetch_min") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_min_async, args);
    } 

    /*
    if (rmw_name.find("dec_atomic_fetch_add") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_add_async, args);
    } else if (rmw_name.find("dec_atomic_fetch_min") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_min_async, args);
    } else if (rmw_name.find("dec_atomic_compare_exchange") != std::string::npos) {
      //Builder.CreateCall(dec_atomic_compare_exchange_async, args);
      Builder.CreateCall(supply_alu_rmw_cas, args);
    } else if (rmw_name.find("dec_atomic_fetch_add_float") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_add_float, args);
    } else if (rmw_name.find("dec_atomic_fetch_and") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_and_async, args);
    } else if (rmw_name.find("dec_atomic_fetch_or") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_or_async, args);
    } else if (rmw_name.find("dec_atomic_fetch_max") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_max_async, args);
    } else if (rmw_name.find("dec_atomic_fetch_xor") != std::string::npos) {
      Builder.CreateCall(dec_atomic_fetch_xor_async, args);
    } else if (rmw_name.find("dec_atomic_exchange") != std::string::npos) {
      Builder.CreateCall(dec_atomic_exchange_async, args);
      }*/
    to_erase.push_back(CI);
    erase_tree(CI->getArgOperand(0));
    PROMOTED_RMWS++; 
  ...
  void instrument_compute(Module &M, Function &f) {
    ...
    errs() << "[Inside Instrument_Compute]\n";
    Instruction *Intr;
    for (inst_iterator iI = inst_begin(&f), iE = inst_end(&f); iI != iE; ++iI) {
      if (isa_compute_consume(&(*iI))) {
	//errs() << "[Found Compute Consume:";
	//errs() << *(&(*iI)) << "]\n";
	Value * V = dyn_cast<Value>(&(*iI));
	//errs() << "[Cast Successful]\n";
	...
	errs() << "[In the compute_exclusive part]\n";
	errs() << "[Instruction:" << *(&(*iI)) << "]\n";
        CallInst *CI = dyn_cast<CallInst>(&(*iI));
        IRBuilder<> Builder(CI);
	//Instruction *I;
        if (CI->getCalledFunction()->getName().str().find("compute_exclusive_load") != std::string::npos) {
          EXCLUSIVE_LOADS++;
	  errs() << "[In the compute_exclusive_load conversion]\n";
	  vector<Value *> args(CI->arg_begin(), CI->arg_end());
          auto I = Builder.CreateLoad(args[0]);
          CI->replaceAllUsesWith(I);
          to_erase.push_back(CI);

        } else if (CI->getCalledFunction()->getName().str().find("compute_exclusive_store") != std::string::npos) {
	  errs() << "[In the compute_exclusive_store conversion]\n";
          EXCLUSIVE_STORES++;
	  vector<Value *> args(CI->arg_begin(), CI->arg_end());
	  Builder.CreateStore(args[1], args[0]);
          ...
          EXCLUSIVE_RMWS++;}
	/*errs() << "[In the compute_exclusive_fetch_add conversion]\n";
	  vector<Value *> args(CI->arg_begin(), CI->arg_end());
          auto I = Builder.CreateCall(dec_atomic_fetch_add, args);
	  errs() << "[Created dec_atomic_fetch_add conversion]\n";
          Builder.CreateCall(count_exclusive_rmw);
          CI->replaceAllUsesWith(I);
          to_erase.push_back(CI);
	  } */else if (CI->getCalledFunction()->getName().str().find("compute_exclusive_compare_exchange") != std::string::npos) {
	  EXCLUSIVE_RMWS++;
	  errs() << "[In the compute_exclusive_compare_exchange conversion]\n";
	  errs() << "[Going to create Instruction:" << *dec_atomic_compare_exchange << "]\n";
	  vector<Value *> args(CI->arg_begin(), CI->arg_end());
	  Function * toInsert = dec_atomic_compare_exchange;
	  auto I = Builder.CreateCall(toInsert, args);
	  //I = Builder.CreateCall(dec_atomic_compare_exchange, args);
	  errs() << "[Created dec_atomic_compare_exchange conversion]\n";
	  Builder.CreateCall(count_exclusive_rmw);
	  //CI->replaceAllUsesWith(I);
	  //to_erase.push_back(CI);
	  }
    ...
    errs() << "[End of Instrument Compute] \n";
  ...
  void instrument_supply(Module &M, Function &f) {
	...
	CallInst *CI = dyn_cast<CallInst>(&(*iI));
        ...
        if (CI->getCalledFunction()->getName().str().find("supply_exclusive_load") != std::string::npos) {
          ...
          CI->replaceAllUsesWith(I);
          to_erase.push_back(CI);
        } else if (CI->getCalledFunction()->getName().str().find("supply_exclusive_store") != std::string::npos) {
          EXCLUSIVE_STORES++;
          Builder.CreateStore(args[1], args[0]);
          to_erase.push_back(CI);
        }
	else {
	  errs() << "unrecognized supply exclusive: \n";
	  errs() << *CI << "\n";
	  assert(false);
	}
      }
  ...
  struct DecoupleSupplyAddrPass : public ModulePass {
	...
	if (isSupplyKernelFunction(*fI)) {
      ...
      errs() << "[COMPUTE EXCLUSIVE LOADS : " << EXCLUSIVE_LOADS << "]\n";
